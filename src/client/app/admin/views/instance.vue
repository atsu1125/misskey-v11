...
<div>
	...
	<ui-card>
		...
		<section>
			...
			<ui-switch v-model="disableTimelinePreview" :disabled="!$store.getters.isAdmin">{{ $t('disable-timeline-preview') }}</ui-switch>
			<ui-switch v-model="disableProfileDirectory" :disabled="!$store.getters.isAdmin">{{ $t('disable-profile-directory') }}</ui-switch>
		</section>
		<section>
			...
			<ui-switch v-model="disableTrends" :disabled="!$store.getters.isAdmin">{{ $t('disable-trends') }}</ui-switch>
		</section>
		<section>
			<ui-button @click="updateMeta" :disabled="!$store.getters.isAdmin"><fa :icon="faSave"/> {{ $t('save') }}</ui-button>
		</section>
